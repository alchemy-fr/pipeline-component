...
use Alchemy\Pipeline\Element\IfFalseElement;
use Alchemy\Pipeline\PipelineElement;
use Alchemy\Pipeline\Specification;
use Alchemy\Resource\Resource;

class IfFalseElementTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testResourceIsProcessedWhenSpecificationIsNotSatisfied()
    {
        ...
        $element = new IfFalseElement($specification->reveal(), $nestedElement->reveal());
